    ...
    <div className="py-32 md:py-45 lg:py-50 z-0 overflow-x-clip">
      ...
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <a href="https://www.linkedin.com/in/philani-a-dlamini-1900121a5/" target='_blank' className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl">
            <span>👋🏽</span>
